...
public class MessageAdapterUser extends RecyclerView.Adapter<MessageAdapterUser.MessageViewHolder>{
    ...
    public MessageAdapterUser(Context context, String userId) {
        this.userId = userId;
